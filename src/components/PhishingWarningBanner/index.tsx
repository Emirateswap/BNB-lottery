    ...
    <Container>
      {isMobile || isMd ? (
        ...
        <>
          <InnerContainer>
            <picture>
              <source type="image/webp" srcSet="/bnblot/images/decorations/phishing-warning-bunny.webp" />
              <source type="image/png" srcSet="/bnblot/images/decorations/phishing-warning-bunny.png" />
              <img src="/bnblot/images/decorations/phishing-warning-bunny.png" alt="phishing-warning" width="92px" />
            </picture>
