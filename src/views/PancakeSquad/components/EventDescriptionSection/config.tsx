...
const eventDescriptionConfigBuilder = ({ t }: EventDescriptionType) => ({
  ...
  image: { src: '/bnblot/images/pancakeSquad/moonBunny/body.png', alt: 'moon bunny' },
  accessoriesImages: [
    { src: '/bnblot/images/pancakeSquad/moonBunny/band.png', alt: 'headband' },
    { src: '/bnblot/images/pancakeSquad/moonBunny/cloth.png', alt: 'cloth' },
    { src: '/bnblot/images/pancakeSquad/moonBunny/glasses.png', alt: 'glasses' },
    { src: '/bnblot/images/pancakeSquad/moonBunny/pancake.png', alt: 'pancake' },
  ],
})
