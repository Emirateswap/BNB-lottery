...
const ClaimInnerContainer: React.FC<ClaimInnerProps> = ({ onSuccess, roundsToClaim }) => {
  ...
  const bnbReward = activeClaimData.bnbTotal
  const dollarReward = bnbReward.times(bnbPriceBusd)
  const rewardAsBalance = getBalanceAmount(bnbReward).toNumber()
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your BNB prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
