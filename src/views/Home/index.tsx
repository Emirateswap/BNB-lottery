...
const Home: React.FC = () => {
  ...
  const [onPresentPresaleModal] = useModal(<PresaleModal />)

  useEffect(() => {
    onPresentPresaleModal()
  ...
  return (
    <>
      ...
      <StyledHeroSection
        ...
        background={
          theme.isDark
            ...
            : 'linear-gradient(139.73deg, #85527C 0%, #85527C 100%)'
        }
        index={2}
      ...
      <PageSection
        ...
        hasCurvedDivider={false}
      >
        <SalesSection {...cakeSectionData} showButton={true} />
        {/* <CakeDataRow /> */}
      </PageSection>
      <PageSection
        innerProps={{ style: HomeSectionContainerStyles }}
